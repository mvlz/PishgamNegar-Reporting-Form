      ...
      var n = i(0),
        a = {
          ...
          toolbox: {
            ...
            cancelButton: {
              enabled: !0,
              text: { fa: "لغو", en: "Cancel" },
              onCancel: function (e) {
                n.debug(e, "dayPicker Event: onCancel");
              },
            },
            calendarSwitch: {
              enabled: !0,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  $(document).on(
                    ...
                    $(document).on(
                      "click",
                      "#" + e.model.view.id + " .pwt-btn-cancel",
                      function () {
                        e.model.view.hide(),
                          e.model.options.toolbox.cancelButton.onCancel(
                            e.model
                          ),
                          e.model.options.onHide(this);
                      }
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return {
                    ...
                    cancelButtonText: this._getButtonText().cancelButtonText,
                  };
                },
              },
              {
                  ...
                  return (
                    "fa" == this.model.options.locale_
                      ? ((e.todayButtontext =
                        ...
                        (e.cancelButtonText =
                          this.model.options.toolbox.cancelButton.text.fa))
                      : "en" == this.model.options.locale_ &&
                        ...
                        (e.cancelButtonText =
                          this.model.options.toolbox.cancelButton.text.en)),
                    e
                  );
                },
              },
